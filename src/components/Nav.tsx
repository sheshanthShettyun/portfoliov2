  ...
  return (
    ...
    >
      <div className="mx-auto flex h-[72px] max-w-[1440px] items-center justify-between px-5 md:px-10">
        <div className="flex w-full items-center justify-between rounded-2xl bg-black/[0.03] px-6 py-3">
            ...
            <AnimatePresence>
              {menuOpen && (
                <motion.div
                  ...
                  className="absolute right-0 top-[calc(100%+8px)] w-[200px] overflow-hidden rounded-[16px] bg-white/95 backdrop-blur-xl p-1.5 shadow-[0_1px_2px_rgba(0,0,0,0.04),0_8px_20px_rgba(0,0,0,0.08),0_20px_44px_rgba(0,0,0,0.06)]"
                >
                  {links.map((link, i) => (
                    <motion.a
                      key={link.href}
